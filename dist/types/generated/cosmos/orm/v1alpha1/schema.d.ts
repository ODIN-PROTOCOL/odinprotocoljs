...
export declare const ModuleSchemaDescriptor: {
    ...
    create<I extends {
        ...
        schemaFile?: ({
            ...
            protoFileName?: string | undefined;
            storageType?: StorageType | undefined;
        } & { [K in Exclude<keyof I["schemaFile"][number], keyof ModuleSchemaDescriptor_FileEntry>]: never; })[] & { [K_1 in Exclude<keyof I["schemaFile"], keyof {
            id?: number | undefined;
            protoFileName?: string | undefined;
            storageType?: StorageType | undefined;
        }[]>]: never; }) | undefined;
        prefix?: Uint8Array | undefined;
    } & { [K_2 in Exclude<keyof I, keyof ModuleSchemaDescriptor>]: never; }>(base?: I | undefined): ModuleSchemaDescriptor;
    fromPartial<I_1 extends {
        ...
        schemaFile?: ({
            ...
            protoFileName?: string | undefined;
            storageType?: StorageType | undefined;
        } & { [K_3 in Exclude<keyof I_1["schemaFile"][number], keyof ModuleSchemaDescriptor_FileEntry>]: never; })[] & { [K_4 in Exclude<keyof I_1["schemaFile"], keyof {
            id?: number | undefined;
            protoFileName?: string | undefined;
            storageType?: StorageType | undefined;
        }[]>]: never; }) | undefined;
        prefix?: Uint8Array | undefined;
    } & { [K_5 in Exclude<keyof I_1, keyof ModuleSchemaDescriptor>]: never; }>(object: I_1): ModuleSchemaDescriptor;
};
export declare const ModuleSchemaDescriptor_FileEntry: {
    ...
    create<I extends {
        ...
        protoFileName?: string | undefined;
        storageType?: StorageType | undefined;
    } & { [K in Exclude<keyof I, keyof ModuleSchemaDescriptor_FileEntry>]: never; }>(base?: I | undefined): ModuleSchemaDescriptor_FileEntry;
    fromPartial<I_1 extends {
        id?: number | undefined;
        protoFileName?: string | undefined;
        storageType?: StorageType | undefined;
        ...
        protoFileName?: string | undefined;
        storageType?: StorageType | undefined;
    } & { [K_1 in Exclude<keyof I_1, keyof ModuleSchemaDescriptor_FileEntry>]: never; }>(object: I_1): ModuleSchemaDescriptor_FileEntry;
};
