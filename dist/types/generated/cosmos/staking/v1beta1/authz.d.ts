...
export declare const StakeAuthorization: {
    ...
    create<I extends {
        ...
        authorizationType?: AuthorizationType | undefined;
    } & { [K_5 in Exclude<keyof I, keyof StakeAuthorization>]: never; }>(base?: I | undefined): StakeAuthorization;
...
export declare const StakeAuthorization_Validators: {
    ...
    } & { [K_1 in Exclude<keyof I, "address">]: never; }>(base?: I | undefined): StakeAuthorization_Validators;
    fromPartial<I_1 extends {
        address?: string[] | undefined;
    } & {
