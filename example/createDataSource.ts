...
const client = await SigningStargateClient.connectWithSigner(
    config_rpc, // Replace with your own RPC endpoint
    wallet,
    { registry: myRegistry },
);
...
const fee = {
    amount: [
      {
        denom: "loki", // Use the appropriate fee denom for your chain
        amount: "120000",
      },
    ],
    gas: "10000",
